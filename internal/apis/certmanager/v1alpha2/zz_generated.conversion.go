...
func autoConvert_certmanager_VenafiTPP_To_v1alpha2_VenafiTPP(in *certmanager.VenafiTPP, out *VenafiTPP, s conversion.Scope) error {
	...
	out.CABundle = *(*[]byte)(unsafe.Pointer(&in.CABundle))
	// WARNING: in.CABundleSecretRef requires manual conversion: does not exist in peer-type
	// WARNING: in.CABundleConfigMapRef requires manual conversion: does not exist in peer-type
	return nil
}
