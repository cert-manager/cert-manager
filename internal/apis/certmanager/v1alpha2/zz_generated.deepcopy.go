...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtraName) DeepCopyInto(out *ExtraName) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtraName.
func (in *ExtraName) DeepCopy() *ExtraName {
	if in == nil {
		return nil
	}
	out := new(ExtraName)
