...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AdditionalOutputFormat)(nil), (*certmanager.AdditionalOutputFormat)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(a.(*AdditionalOutputFormat), b.(*certmanager.AdditionalOutputFormat), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.AdditionalOutputFormat)(nil), (*AdditionalOutputFormat)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_AdditionalOutputFormat_To_v1beta1_AdditionalOutputFormat(a.(*certmanager.AdditionalOutputFormat), b.(*AdditionalOutputFormat), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(in *AdditionalOutputFormat, out *certmanager.AdditionalOutputFormat, s conversion.Scope) error {
	out.Type = certmanager.OutputFormatType(in.Type)
	return nil
}

// Convert_v1beta1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat is an autogenerated conversion function.
func Convert_v1beta1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(in *AdditionalOutputFormat, out *certmanager.AdditionalOutputFormat, s conversion.Scope) error {
	return autoConvert_v1beta1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(in, out, s)
}

func autoConvert_certmanager_AdditionalOutputFormat_To_v1beta1_AdditionalOutputFormat(in *certmanager.AdditionalOutputFormat, out *AdditionalOutputFormat, s conversion.Scope) error {
	out.Type = OutputFormatType(in.Type)
	return nil
}

// Convert_certmanager_AdditionalOutputFormat_To_v1beta1_AdditionalOutputFormat is an autogenerated conversion function.
func Convert_certmanager_AdditionalOutputFormat_To_v1beta1_AdditionalOutputFormat(in *certmanager.AdditionalOutputFormat, out *AdditionalOutputFormat, s conversion.Scope) error {
	return autoConvert_certmanager_AdditionalOutputFormat_To_v1beta1_AdditionalOutputFormat(in, out, s)
}
...
func autoConvert_v1beta1_CertificateSpec_To_certmanager_CertificateSpec(in *CertificateSpec, out *certmanager.CertificateSpec, s conversion.Scope) error {
	...
	if in.PrivateKey != nil {
		...
		*out = new(certmanager.CertificatePrivateKey)
		if err := Convert_v1beta1_CertificatePrivateKey_To_certmanager_CertificatePrivateKey(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.PrivateKey = nil
