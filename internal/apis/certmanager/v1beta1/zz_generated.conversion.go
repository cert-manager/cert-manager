...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ExtraName)(nil), (*certmanager.ExtraName)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ExtraName_To_certmanager_ExtraName(a.(*ExtraName), b.(*certmanager.ExtraName), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.ExtraName)(nil), (*ExtraName)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_ExtraName_To_v1beta1_ExtraName(a.(*certmanager.ExtraName), b.(*ExtraName), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ExtraName_To_certmanager_ExtraName(in *ExtraName, out *certmanager.ExtraName, s conversion.Scope) error {
	out.Type = in.Type
	out.Value = in.Value
	return nil
}

// Convert_v1beta1_ExtraName_To_certmanager_ExtraName is an autogenerated conversion function.
func Convert_v1beta1_ExtraName_To_certmanager_ExtraName(in *ExtraName, out *certmanager.ExtraName, s conversion.Scope) error {
	return autoConvert_v1beta1_ExtraName_To_certmanager_ExtraName(in, out, s)
}

func autoConvert_certmanager_ExtraName_To_v1beta1_ExtraName(in *certmanager.ExtraName, out *ExtraName, s conversion.Scope) error {
	out.Type = in.Type
	out.Value = in.Value
	return nil
}

// Convert_certmanager_ExtraName_To_v1beta1_ExtraName is an autogenerated conversion function.
func Convert_certmanager_ExtraName_To_v1beta1_ExtraName(in *certmanager.ExtraName, out *ExtraName, s conversion.Scope) error {
	return autoConvert_certmanager_ExtraName_To_v1beta1_ExtraName(in, out, s)
}
