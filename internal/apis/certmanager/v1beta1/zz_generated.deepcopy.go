...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultCaBundleSecretRef) DeepCopyInto(out *VaultCaBundleSecretRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultCaBundleSecretRef.
func (in *VaultCaBundleSecretRef) DeepCopy() *VaultCaBundleSecretRef {
	if in == nil {
		return nil
	}
	out := new(VaultCaBundleSecretRef)
	in.DeepCopyInto(out)
	return out
}
