...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ExtraName)(nil), (*certmanager.ExtraName)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ExtraName_To_certmanager_ExtraName(a.(*v1.ExtraName), b.(*certmanager.ExtraName), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.ExtraName)(nil), (*v1.ExtraName)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_ExtraName_To_v1_ExtraName(a.(*certmanager.ExtraName), b.(*v1.ExtraName), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ExtraName_To_certmanager_ExtraName(in *v1.ExtraName, out *certmanager.ExtraName, s conversion.Scope) error {
	out.Type = in.Type
	out.Value = in.Value
	return nil
}

// Convert_v1_ExtraName_To_certmanager_ExtraName is an autogenerated conversion function.
func Convert_v1_ExtraName_To_certmanager_ExtraName(in *v1.ExtraName, out *certmanager.ExtraName, s conversion.Scope) error {
	return autoConvert_v1_ExtraName_To_certmanager_ExtraName(in, out, s)
}

func autoConvert_certmanager_ExtraName_To_v1_ExtraName(in *certmanager.ExtraName, out *v1.ExtraName, s conversion.Scope) error {
	out.Type = in.Type
	out.Value = in.Value
	return nil
}

// Convert_certmanager_ExtraName_To_v1_ExtraName is an autogenerated conversion function.
func Convert_certmanager_ExtraName_To_v1_ExtraName(in *certmanager.ExtraName, out *v1.ExtraName, s conversion.Scope) error {
	return autoConvert_certmanager_ExtraName_To_v1_ExtraName(in, out, s)
}
...
func autoConvert_certmanager_X509Subject_To_v1_X509Subject(in *certmanager.X509Subject, out *v1.X509Subject, s conversion.Scope) error {
	...
	out.PostalCodes = *(*[]string)(unsafe.Pointer(&in.PostalCodes))
	out.SerialNumber = in.SerialNumber
	out.ExtraNames = *(*[]v1.ExtraName)(unsafe.Pointer(&in.ExtraNames))
	return nil
}
