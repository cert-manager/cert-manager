...
import (
	...
	acmev1 "github.com/jetstack/cert-manager/internal/apis/acme/v1"
	...
	internalapismetav1 "github.com/jetstack/cert-manager/internal/apis/meta/v1"
...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1.AdditionalOutputFormat)(nil), (*certmanager.AdditionalOutputFormat)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(a.(*v1.AdditionalOutputFormat), b.(*certmanager.AdditionalOutputFormat), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.AdditionalOutputFormat)(nil), (*v1.AdditionalOutputFormat)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_AdditionalOutputFormat_To_v1_AdditionalOutputFormat(a.(*certmanager.AdditionalOutputFormat), b.(*v1.AdditionalOutputFormat), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(in *v1.AdditionalOutputFormat, out *certmanager.AdditionalOutputFormat, s conversion.Scope) error {
	out.Type = certmanager.OutputFormatType(in.Type)
	return nil
}

// Convert_v1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat is an autogenerated conversion function.
func Convert_v1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(in *v1.AdditionalOutputFormat, out *certmanager.AdditionalOutputFormat, s conversion.Scope) error {
	return autoConvert_v1_AdditionalOutputFormat_To_certmanager_AdditionalOutputFormat(in, out, s)
}

func autoConvert_certmanager_AdditionalOutputFormat_To_v1_AdditionalOutputFormat(in *certmanager.AdditionalOutputFormat, out *v1.AdditionalOutputFormat, s conversion.Scope) error {
	out.Type = v1.OutputFormatType(in.Type)
	return nil
}

// Convert_certmanager_AdditionalOutputFormat_To_v1_AdditionalOutputFormat is an autogenerated conversion function.
func Convert_certmanager_AdditionalOutputFormat_To_v1_AdditionalOutputFormat(in *certmanager.AdditionalOutputFormat, out *v1.AdditionalOutputFormat, s conversion.Scope) error {
	return autoConvert_certmanager_AdditionalOutputFormat_To_v1_AdditionalOutputFormat(in, out, s)
}
...
func autoConvert_certmanager_CertificateSpec_To_v1_CertificateSpec(in *certmanager.CertificateSpec, out *v1.CertificateSpec, s conversion.Scope) error {
	...
	out.EncodeUsagesInRequest = (*bool)(unsafe.Pointer(in.EncodeUsagesInRequest))
	out.RevisionHistoryLimit = (*int32)(unsafe.Pointer(in.RevisionHistoryLimit))
	out.AdditionalOutputFormats = *(*[]v1.AdditionalOutputFormat)(unsafe.Pointer(&in.AdditionalOutputFormats))
	return nil
}
