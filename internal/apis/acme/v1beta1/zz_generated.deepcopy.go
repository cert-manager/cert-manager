...
func (in *ACMEChallengeSolverHTTP01IngressPodSpec) DeepCopyInto(out *ACMEChallengeSolverHTTP01IngressPodSpec) {
	*out = *in
	...
	if in.Resources != nil {
		...
		*out = new(ACMEChallengeSolverHTTP01IngressPodSpecResources)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACMEChallengeSolverHTTP01IngressPodSpecResources) DeepCopyInto(out *ACMEChallengeSolverHTTP01IngressPodSpecResources) {
	*out = *in
	if in.Limits != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEChallengeSolverHTTP01IngressPodSpecResources.
func (in *ACMEChallengeSolverHTTP01IngressPodSpecResources) DeepCopy() *ACMEChallengeSolverHTTP01IngressPodSpecResources {
	if in == nil {
		return nil
	}
	out := new(ACMEChallengeSolverHTTP01IngressPodSpecResources)
