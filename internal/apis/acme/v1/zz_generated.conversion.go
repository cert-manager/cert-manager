...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ACMEChallengeSolverHTTP01IngressPodSpecResources)(nil), (*acme.ACMEChallengeSolverHTTP01IngressPodSpecResources)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources(a.(*v1.ACMEChallengeSolverHTTP01IngressPodSpecResources), b.(*acme.ACMEChallengeSolverHTTP01IngressPodSpecResources), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ACMEChallengeSolverHTTP01IngressPodSpecResources)(nil), (*v1.ACMEChallengeSolverHTTP01IngressPodSpecResources)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources(a.(*acme.ACMEChallengeSolverHTTP01IngressPodSpecResources), b.(*v1.ACMEChallengeSolverHTTP01IngressPodSpecResources), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_acme_ACMEChallengeSolverHTTP01IngressPodSpec_To_v1_ACMEChallengeSolverHTTP01IngressPodSpec(in *acme.ACMEChallengeSolverHTTP01IngressPodSpec, out *v1.ACMEChallengeSolverHTTP01IngressPodSpec, s conversion.Scope) error {
	...
	out.ServiceAccountName = in.ServiceAccountName
	out.ImagePullSecrets = *(*[]corev1.LocalObjectReference)(unsafe.Pointer(&in.ImagePullSecrets))
	out.Resources = (*v1.ACMEChallengeSolverHTTP01IngressPodSpecResources)(unsafe.Pointer(in.Resources))
	return nil
}
...
func autoConvert_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources(in *v1.ACMEChallengeSolverHTTP01IngressPodSpecResources, out *acme.ACMEChallengeSolverHTTP01IngressPodSpecResources, s conversion.Scope) error {
	out.Limits = *(*corev1.ResourceList)(unsafe.Pointer(&in.Limits))
	out.Requests = *(*corev1.ResourceList)(unsafe.Pointer(&in.Requests))
	return nil
}

// Convert_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources is an autogenerated conversion function.
func Convert_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources(in *v1.ACMEChallengeSolverHTTP01IngressPodSpecResources, out *acme.ACMEChallengeSolverHTTP01IngressPodSpecResources, s conversion.Scope) error {
	return autoConvert_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources(in, out, s)
}

func autoConvert_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources(in *acme.ACMEChallengeSolverHTTP01IngressPodSpecResources, out *v1.ACMEChallengeSolverHTTP01IngressPodSpecResources, s conversion.Scope) error {
	out.Limits = *(*corev1.ResourceList)(unsafe.Pointer(&in.Limits))
	out.Requests = *(*corev1.ResourceList)(unsafe.Pointer(&in.Requests))
	return nil
}

// Convert_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources is an autogenerated conversion function.
func Convert_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources(in *acme.ACMEChallengeSolverHTTP01IngressPodSpecResources, out *v1.ACMEChallengeSolverHTTP01IngressPodSpecResources, s conversion.Scope) error {
	return autoConvert_acme_ACMEChallengeSolverHTTP01IngressPodSpecResources_To_v1_ACMEChallengeSolverHTTP01IngressPodSpecResources(in, out, s)
}
