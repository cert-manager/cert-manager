...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*acmev1.AccountPrivateKey)(nil), (*acme.AccountPrivateKey)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_AccountPrivateKey_To_acme_AccountPrivateKey(a.(*acmev1.AccountPrivateKey), b.(*acme.AccountPrivateKey), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.AccountPrivateKey)(nil), (*acmev1.AccountPrivateKey)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_AccountPrivateKey_To_v1_AccountPrivateKey(a.(*acme.AccountPrivateKey), b.(*acmev1.AccountPrivateKey), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ACMEIssuer_To_acme_ACMEIssuer(in *acmev1.ACMEIssuer, out *acme.ACMEIssuer, s conversion.Scope) error {
	...
	out.AccountPrivateKey = (*acme.AccountPrivateKey)(unsafe.Pointer(in.AccountPrivateKey))
...
func autoConvert_acme_ACMEIssuer_To_v1_ACMEIssuer(in *acme.ACMEIssuer, out *acmev1.ACMEIssuer, s conversion.Scope) error {
	...
	out.DisableAccountKeyGeneration = in.DisableAccountKeyGeneration
	out.AccountPrivateKey = (*acmev1.AccountPrivateKey)(unsafe.Pointer(in.AccountPrivateKey))
	out.EnableDurationFeature = in.EnableDurationFeature
	out.Profile = in.Profile
	return nil
}
...
func autoConvert_v1_AccountPrivateKey_To_acme_AccountPrivateKey(in *acmev1.AccountPrivateKey, out *acme.AccountPrivateKey, s conversion.Scope) error {
	out.Algorithm = acme.AccountKeyAlgorithm(in.Algorithm)
	out.Size = in.Size
	return nil
}

// Convert_v1_AccountPrivateKey_To_acme_AccountPrivateKey is an autogenerated conversion function.
func Convert_v1_AccountPrivateKey_To_acme_AccountPrivateKey(in *acmev1.AccountPrivateKey, out *acme.AccountPrivateKey, s conversion.Scope) error {
	return autoConvert_v1_AccountPrivateKey_To_acme_AccountPrivateKey(in, out, s)
}

func autoConvert_acme_AccountPrivateKey_To_v1_AccountPrivateKey(in *acme.AccountPrivateKey, out *acmev1.AccountPrivateKey, s conversion.Scope) error {
	out.Algorithm = acmev1.AccountKeyAlgorithm(in.Algorithm)
	out.Size = in.Size
	return nil
}

// Convert_acme_AccountPrivateKey_To_v1_AccountPrivateKey is an autogenerated conversion function.
func Convert_acme_AccountPrivateKey_To_v1_AccountPrivateKey(in *acme.AccountPrivateKey, out *acmev1.AccountPrivateKey, s conversion.Scope) error {
	return autoConvert_acme_AccountPrivateKey_To_v1_AccountPrivateKey(in, out, s)
}
