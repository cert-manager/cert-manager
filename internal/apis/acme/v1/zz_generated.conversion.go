...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*acmev1.ChallengeCondition)(nil), (*acme.ChallengeCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ChallengeCondition_To_acme_ChallengeCondition(a.(*acmev1.ChallengeCondition), b.(*acme.ChallengeCondition), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ChallengeCondition)(nil), (*acmev1.ChallengeCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ChallengeCondition_To_v1_ChallengeCondition(a.(*acme.ChallengeCondition), b.(*acmev1.ChallengeCondition), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*acmev1.ChallengeSolverStatus)(nil), (*acme.ChallengeSolverStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ChallengeSolverStatus_To_acme_ChallengeSolverStatus(a.(*acmev1.ChallengeSolverStatus), b.(*acme.ChallengeSolverStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ChallengeSolverStatus)(nil), (*acmev1.ChallengeSolverStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ChallengeSolverStatus_To_v1_ChallengeSolverStatus(a.(*acme.ChallengeSolverStatus), b.(*acmev1.ChallengeSolverStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acmev1.ChallengeSolverStatusDNS)(nil), (*acme.ChallengeSolverStatusDNS)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ChallengeSolverStatusDNS_To_acme_ChallengeSolverStatusDNS(a.(*acmev1.ChallengeSolverStatusDNS), b.(*acme.ChallengeSolverStatusDNS), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ChallengeSolverStatusDNS)(nil), (*acmev1.ChallengeSolverStatusDNS)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ChallengeSolverStatusDNS_To_v1_ChallengeSolverStatusDNS(a.(*acme.ChallengeSolverStatusDNS), b.(*acmev1.ChallengeSolverStatusDNS), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acmev1.ChallengeSolverStatusHTTP)(nil), (*acme.ChallengeSolverStatusHTTP)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ChallengeSolverStatusHTTP_To_acme_ChallengeSolverStatusHTTP(a.(*acmev1.ChallengeSolverStatusHTTP), b.(*acme.ChallengeSolverStatusHTTP), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ChallengeSolverStatusHTTP)(nil), (*acmev1.ChallengeSolverStatusHTTP)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ChallengeSolverStatusHTTP_To_v1_ChallengeSolverStatusHTTP(a.(*acme.ChallengeSolverStatusHTTP), b.(*acmev1.ChallengeSolverStatusHTTP), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ChallengeCondition_To_acme_ChallengeCondition(in *acmev1.ChallengeCondition, out *acme.ChallengeCondition, s conversion.Scope) error {
...
func Convert_v1_ChallengeCondition_To_acme_ChallengeCondition(in *acmev1.ChallengeCondition, out *acme.ChallengeCondition, s conversion.Scope) error {
	return autoConvert_v1_ChallengeCondition_To_acme_ChallengeCondition(in, out, s)
}

func autoConvert_acme_ChallengeCondition_To_v1_ChallengeCondition(in *acme.ChallengeCondition, out *acmev1.ChallengeCondition, s conversion.Scope) error {
	out.Type = acmev1.ChallengeConditionType(in.Type)
...
func Convert_acme_ChallengeCondition_To_v1_ChallengeCondition(in *acme.ChallengeCondition, out *acmev1.ChallengeCondition, s conversion.Scope) error {
...
func autoConvert_v1_ChallengeSolverStatus_To_acme_ChallengeSolverStatus(in *acmev1.ChallengeSolverStatus, out *acme.ChallengeSolverStatus, s conversion.Scope) error {
	out.DNS = (*acme.ChallengeSolverStatusDNS)(unsafe.Pointer(in.DNS))
	out.HTTP = (*acme.ChallengeSolverStatusHTTP)(unsafe.Pointer(in.HTTP))
	return nil
}

// Convert_v1_ChallengeSolverStatus_To_acme_ChallengeSolverStatus is an autogenerated conversion function.
func Convert_v1_ChallengeSolverStatus_To_acme_ChallengeSolverStatus(in *acmev1.ChallengeSolverStatus, out *acme.ChallengeSolverStatus, s conversion.Scope) error {
	return autoConvert_v1_ChallengeSolverStatus_To_acme_ChallengeSolverStatus(in, out, s)
}

func autoConvert_acme_ChallengeSolverStatus_To_v1_ChallengeSolverStatus(in *acme.ChallengeSolverStatus, out *acmev1.ChallengeSolverStatus, s conversion.Scope) error {
	out.DNS = (*acmev1.ChallengeSolverStatusDNS)(unsafe.Pointer(in.DNS))
	out.HTTP = (*acmev1.ChallengeSolverStatusHTTP)(unsafe.Pointer(in.HTTP))
	return nil
}

// Convert_acme_ChallengeSolverStatus_To_v1_ChallengeSolverStatus is an autogenerated conversion function.
func Convert_acme_ChallengeSolverStatus_To_v1_ChallengeSolverStatus(in *acme.ChallengeSolverStatus, out *acmev1.ChallengeSolverStatus, s conversion.Scope) error {
	return autoConvert_acme_ChallengeSolverStatus_To_v1_ChallengeSolverStatus(in, out, s)
}

func autoConvert_v1_ChallengeSolverStatusDNS_To_acme_ChallengeSolverStatusDNS(in *acmev1.ChallengeSolverStatusDNS, out *acme.ChallengeSolverStatusDNS, s conversion.Scope) error {
	out.TTL = (*pkgapismetav1.Duration)(unsafe.Pointer(in.TTL))
	out.LastSuccess = (*pkgapismetav1.Time)(unsafe.Pointer(in.LastSuccess))
	out.FQDN = in.FQDN
	return nil
}

// Convert_v1_ChallengeSolverStatusDNS_To_acme_ChallengeSolverStatusDNS is an autogenerated conversion function.
func Convert_v1_ChallengeSolverStatusDNS_To_acme_ChallengeSolverStatusDNS(in *acmev1.ChallengeSolverStatusDNS, out *acme.ChallengeSolverStatusDNS, s conversion.Scope) error {
	return autoConvert_v1_ChallengeSolverStatusDNS_To_acme_ChallengeSolverStatusDNS(in, out, s)
}

func autoConvert_acme_ChallengeSolverStatusDNS_To_v1_ChallengeSolverStatusDNS(in *acme.ChallengeSolverStatusDNS, out *acmev1.ChallengeSolverStatusDNS, s conversion.Scope) error {
	out.TTL = (*pkgapismetav1.Duration)(unsafe.Pointer(in.TTL))
	out.LastSuccess = (*pkgapismetav1.Time)(unsafe.Pointer(in.LastSuccess))
	out.FQDN = in.FQDN
	return nil
...
// Convert_acme_ChallengeSolverStatusDNS_To_v1_ChallengeSolverStatusDNS is an autogenerated conversion function.
func Convert_acme_ChallengeSolverStatusDNS_To_v1_ChallengeSolverStatusDNS(in *acme.ChallengeSolverStatusDNS, out *acmev1.ChallengeSolverStatusDNS, s conversion.Scope) error {
	return autoConvert_acme_ChallengeSolverStatusDNS_To_v1_ChallengeSolverStatusDNS(in, out, s)
}

func autoConvert_v1_ChallengeSolverStatusHTTP_To_acme_ChallengeSolverStatusHTTP(in *acmev1.ChallengeSolverStatusHTTP, out *acme.ChallengeSolverStatusHTTP, s conversion.Scope) error {
	out.RequiredSuccesses = in.RequiredSuccesses
	out.Successes = in.Successes
	return nil
}

// Convert_v1_ChallengeSolverStatusHTTP_To_acme_ChallengeSolverStatusHTTP is an autogenerated conversion function.
func Convert_v1_ChallengeSolverStatusHTTP_To_acme_ChallengeSolverStatusHTTP(in *acmev1.ChallengeSolverStatusHTTP, out *acme.ChallengeSolverStatusHTTP, s conversion.Scope) error {
	return autoConvert_v1_ChallengeSolverStatusHTTP_To_acme_ChallengeSolverStatusHTTP(in, out, s)
}

func autoConvert_acme_ChallengeSolverStatusHTTP_To_v1_ChallengeSolverStatusHTTP(in *acme.ChallengeSolverStatusHTTP, out *acmev1.ChallengeSolverStatusHTTP, s conversion.Scope) error {
	out.RequiredSuccesses = in.RequiredSuccesses
	out.Successes = in.Successes
	return nil
}

// Convert_acme_ChallengeSolverStatusHTTP_To_v1_ChallengeSolverStatusHTTP is an autogenerated conversion function.
func Convert_acme_ChallengeSolverStatusHTTP_To_v1_ChallengeSolverStatusHTTP(in *acme.ChallengeSolverStatusHTTP, out *acmev1.ChallengeSolverStatusHTTP, s conversion.Scope) error {
	return autoConvert_acme_ChallengeSolverStatusHTTP_To_v1_ChallengeSolverStatusHTTP(in, out, s)
}
...
func autoConvert_v1_ChallengeStatus_To_acme_ChallengeStatus(in *acmev1.ChallengeStatus, out *acme.ChallengeStatus, s conversion.Scope) error {
	...
	if err := Convert_v1_ChallengeSolverStatus_To_acme_ChallengeSolverStatus(&in.Solver, &out.Solver, s); err != nil {
		return err
	}
	out.NextReconcile = (*pkgapismetav1.Time)(unsafe.Pointer(in.NextReconcile))
	return nil
}
...
func autoConvert_acme_ChallengeStatus_To_v1_ChallengeStatus(in *acme.ChallengeStatus, out *acmev1.ChallengeStatus, s conversion.Scope) error {
	out.Processing = in.Processing
	out.Presented = in.Presented
	out.Conditions = *(*[]acmev1.ChallengeCondition)(unsafe.Pointer(&in.Conditions))
	out.Reason = in.Reason
	out.State = acmev1.State(in.State)
	if err := Convert_acme_ChallengeSolverStatus_To_v1_ChallengeSolverStatus(&in.Solver, &out.Solver, s); err != nil {
		return err
	}
	out.NextReconcile = (*pkgapismetav1.Time)(unsafe.Pointer(in.NextReconcile))
	return nil
