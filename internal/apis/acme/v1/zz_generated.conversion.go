...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ACMEIssuerDNS01ProviderAzurePrivateDNS)(nil), (*acme.ACMEIssuerDNS01ProviderAzurePrivateDNS)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS(a.(*v1.ACMEIssuerDNS01ProviderAzurePrivateDNS), b.(*acme.ACMEIssuerDNS01ProviderAzurePrivateDNS), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ACMEIssuerDNS01ProviderAzurePrivateDNS)(nil), (*v1.ACMEIssuerDNS01ProviderAzurePrivateDNS)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS(a.(*acme.ACMEIssuerDNS01ProviderAzurePrivateDNS), b.(*v1.ACMEIssuerDNS01ProviderAzurePrivateDNS), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ACMEChallengeSolverDNS01_To_acme_ACMEChallengeSolverDNS01(in *acmev1.ACMEChallengeSolverDNS01, out *acme.ACMEChallengeSolverDNS01, s conversion.Scope) error {
	...
	if in.AzurePrivateDNS != nil {
		in, out := &in.AzurePrivateDNS, &out.AzurePrivateDNS
		*out = new(acme.ACMEIssuerDNS01ProviderAzurePrivateDNS)
		if err := Convert_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AzurePrivateDNS = nil
	}
...
func autoConvert_acme_ACMEChallengeSolverDNS01_To_v1_ACMEChallengeSolverDNS01(in *acme.ACMEChallengeSolverDNS01, out *acmev1.ACMEChallengeSolverDNS01, s conversion.Scope) error {
	...
	if in.AzurePrivateDNS != nil {
		in, out := &in.AzurePrivateDNS, &out.AzurePrivateDNS
		*out = new(v1.ACMEIssuerDNS01ProviderAzurePrivateDNS)
		if err := Convert_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AzurePrivateDNS = nil
...
func autoConvert_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS(in *v1.ACMEIssuerDNS01ProviderAzurePrivateDNS, out *acme.ACMEIssuerDNS01ProviderAzurePrivateDNS, s conversion.Scope) error {
	out.ClientID = in.ClientID
	if in.ClientSecret != nil {
		in, out := &in.ClientSecret, &out.ClientSecret
		*out = new(meta.SecretKeySelector)
...
func Convert_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS(in *v1.ACMEIssuerDNS01ProviderAzurePrivateDNS, out *acme.ACMEIssuerDNS01ProviderAzurePrivateDNS, s conversion.Scope) error {
	return autoConvert_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS(in, out, s)
}
...
func autoConvert_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS(in *acme.ACMEIssuerDNS01ProviderAzurePrivateDNS, out *v1.ACMEIssuerDNS01ProviderAzurePrivateDNS, s conversion.Scope) error {
	out.ClientID = in.ClientID
	if in.ClientSecret != nil {
		in, out := &in.ClientSecret, &out.ClientSecret
		*out = new(apismetav1.SecretKeySelector)
...
func Convert_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS(in *acme.ACMEIssuerDNS01ProviderAzurePrivateDNS, out *v1.ACMEIssuerDNS01ProviderAzurePrivateDNS, s conversion.Scope) error {
	return autoConvert_acme_ACMEIssuerDNS01ProviderAzurePrivateDNS_To_v1_ACMEIssuerDNS01ProviderAzurePrivateDNS(in, out, s)
}
