...
func (in *ACMEChallengeSolverDNS01) DeepCopyInto(out *ACMEChallengeSolverDNS01) {
	*out = *in
	...
	if in.AzurePrivateDNS != nil {
		...
		*out = new(ACMEIssuerDNS01ProviderAzurePrivateDNS)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ACMEIssuerDNS01ProviderAzurePrivateDNS) DeepCopyInto(out *ACMEIssuerDNS01ProviderAzurePrivateDNS) {
	*out = *in
	if in.ClientSecret != nil {
		in, out := &in.ClientSecret, &out.ClientSecret
		*out = new(meta.SecretKeySelector)
...
func (in *ACMEIssuerDNS01ProviderAzurePrivateDNS) DeepCopy() *ACMEIssuerDNS01ProviderAzurePrivateDNS {
	if in == nil {
		return nil
	}
	out := new(ACMEIssuerDNS01ProviderAzurePrivateDNS)
