...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChallengeSolverStatus) DeepCopyInto(out *ChallengeSolverStatus) {
	*out = *in
	if in.DNS != nil {
		in, out := &in.DNS, &out.DNS
		*out = new(ChallengeSolverStatusDNS)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = new(ChallengeSolverStatusHTTP)
		**out = **in
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChallengeSolverStatus.
func (in *ChallengeSolverStatus) DeepCopy() *ChallengeSolverStatus {
	if in == nil {
		return nil
	}
	out := new(ChallengeSolverStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChallengeSolverStatusDNS) DeepCopyInto(out *ChallengeSolverStatusDNS) {
	*out = *in
	if in.TTL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChallengeSolverStatusDNS.
func (in *ChallengeSolverStatusDNS) DeepCopy() *ChallengeSolverStatusDNS {
	if in == nil {
		return nil
	}
	out := new(ChallengeSolverStatusDNS)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChallengeSolverStatusHTTP) DeepCopyInto(out *ChallengeSolverStatusHTTP) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChallengeSolverStatusHTTP.
func (in *ChallengeSolverStatusHTTP) DeepCopy() *ChallengeSolverStatusHTTP {
	if in == nil {
		return nil
	}
	out := new(ChallengeSolverStatusHTTP)
