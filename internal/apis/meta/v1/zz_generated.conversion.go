...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1.ConfigMapKeySelector)(nil), (*v1.ConfigMapKeySelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ConfigMapKeySelector_To_v1_ConfigMapKeySelector(a.(*v1.ConfigMapKeySelector), b.(*v1.ConfigMapKeySelector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.ConfigMapKeySelector)(nil), (*v1.ConfigMapKeySelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1_ConfigMapKeySelector_To_v1_ConfigMapKeySelector(in *v1.ConfigMapKeySelector, out *v1.ConfigMapKeySelector, s conversion.Scope) error {
	out.LocalObjectReference = in.LocalObjectReference
	out.Key = in.Key
	return nil
}

// Convert_v1_ConfigMapKeySelector_To_v1_ConfigMapKeySelector is an autogenerated conversion function.
func Convert_v1_ConfigMapKeySelector_To_v1_ConfigMapKeySelector(in *v1.ConfigMapKeySelector, out *v1.ConfigMapKeySelector, s conversion.Scope) error {
	return autoConvert_v1_ConfigMapKeySelector_To_v1_ConfigMapKeySelector(in, out, s)
}
