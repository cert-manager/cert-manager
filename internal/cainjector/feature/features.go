...
// caInjectorFeatureGates defines all feature gates for the ca-injector
// component.
// To add a new feature, define a key for it above and add it here.  To check
// whether a feature is enabled, use:
