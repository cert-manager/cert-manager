...
type Suite struct {
	...
	// will be set to the IP address of the Ingress controller. Only used in the
	// Ingress-based HTTP-01 tests.
	IngressIPAddress string

	// GatewayClassName is the name of the GatewayClass that will be used in all
	// Gateway resources created in the tests. Only used in the Gateway-based
	// HTTP-01 tests.
