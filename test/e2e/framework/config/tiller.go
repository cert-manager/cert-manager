...
func (n *Tiller) AddFlags(fs *flag.FlagSet) {
	fs.StringVar(&n.ImageRepo, "tiller-image-repo", "bazel/test/e2e/addon/tiller", "docker image repo for tiller-deploy")
	fs.StringVar(&n.ImageTag, "tiller-image-tag", "v0.0.0-bazel", "docker image tag for tiller-deploy")
}
