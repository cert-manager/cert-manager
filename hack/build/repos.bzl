...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:PbIRNLKSDnc+P0XT67emLMAItK41ntNYs5K8OUtJQ6U=",
        version = "v0.0.0-20200330134433-8e259f67fc55",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kMiuiZXH1GdfbiMwsuAQOqGaMxlo9NCUk0wT4XAdfNM=",
        version = "v0.0.0-20200326155132-2a6cd50aedd0",
    )
    go_repository(
