...
func RegisterBuildCmd(rootOpts *options.Root, addonOpts *options.Addon, rootCmd *cobra.Command) {
	log := logf.Log.WithName("build")

	cmd := &cobra.Command{
		Use:   "build",
		Short: "Build addon images and export them to the local docker daemon",
