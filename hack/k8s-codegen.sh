...
gen-applyconfigurations() {
  clean "${client_subpackage}"/applyconfiguration '*.go'
 ...
 "$applyconfigurationgen" \
    --go-header-file hack/boilerplate-go.txt \
    --output-dir "${client_subpackage}"/applyconfiguration \
    --output-pkg "${client_package}"/applyconfiguration \
    $joined
}
...
gen-clientsets() {
  ...
  "$clientgen" \
    ...
    --apply-configuration-package "${client_package}"/applyconfiguration \
    --input-base "" \
    --input "$joined" \
