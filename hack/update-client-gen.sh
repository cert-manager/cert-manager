...
${BINDIR}/lister-gen "$@" \
          --input-dirs="github.com/jetstack-experimental/cert-manager/pkg/apis/certmanager/v1alpha1" \
          --output-package "github.com/jetstack-experimental/cert-manager/pkg/client/listers" \
          --go-header-file "${GOPATH}/src/github.com/kubernetes/repo-infra/verify/boilerplate/boilerplate.go.txt"
# generate informer
${BINDIR}/informer-gen "$@" \
          --go-header-file "${GOPATH}/src/github.com/kubernetes/repo-infra/verify/boilerplate/boilerplate.go.txt" \
          --input-dirs "github.com/jetstack-experimental/cert-manager/pkg/apis/certmanager/v1alpha1" \
          --versioned-clientset-package "github.com/jetstack-experimental/cert-manager/pkg/client/clientset" \
