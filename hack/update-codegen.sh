...
gen-conversions() {
  ...
  sed -i 's/\+build \!ignore_autogenerated/TEMP_REPLACE_IGNORE_AUTOGENERATED/g' "pkg/internal/apis/meta/v1/zz_generated.conversion.go"
  ...
  do
    ...
    # Workaround (see: https://github.com/kubernetes/kubernetes/issues/101567)
    sed -i 's/\+build \!ignore_autogenerated/TEMP_REPLACE_IGNORE_AUTOGENERATED/g' "pkg/internal/apis/acme/$v/zz_generated.conversion.go"
    ...
    # Workaround (see: https://github.com/kubernetes/kubernetes/issues/101567)
    sed -i 's/\+build \!ignore_autogenerated/TEMP_REPLACE_IGNORE_AUTOGENERATED/g' "pkg/internal/apis/certmanager/$v/zz_generated.conversion.go"
  done
  ...
  for dir in "${conversion_inputs[@]}"; do
    # Workaround (see: https://github.com/kubernetes/kubernetes/issues/101567)
    sed -i 's/TEMP_REPLACE_IGNORE_AUTOGENERATED/\+build \!ignore_autogenerated/g' "$dir/zz_generated.conversion.go"
