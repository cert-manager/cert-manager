...
func FetchCertificateFromCR(req *cmapiv1.CertificateRequest, certFileName string) error {
	// If CR not ready yet, error
	if !apiutil.CertificateRequestHasCondition(req, cmapiv1.CertificateRequestCondition{
