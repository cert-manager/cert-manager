...
import (
	...
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/acmedns"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/akamai"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/azuredns"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/clouddns"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/cloudflare"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/digitalocean"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/rfc2136"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/route53"
	"github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/util"
	webhookslv "github.com/cert-manager/cert-manager/controller-binary/pkg/issuer/acme/dns/webhook"
