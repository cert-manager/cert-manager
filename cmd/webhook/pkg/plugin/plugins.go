...
import (
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/plugin/admission/apideprecation"
	certificaterequestapproval "github.com/cert-manager/cert-manager/webhook-binary/pkg/plugin/admission/certificaterequest/approval"
	certificaterequestidentity "github.com/cert-manager/cert-manager/webhook-binary/pkg/plugin/admission/certificaterequest/identity"
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/plugin/admission/resourcevalidation"
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/webhook/admission"
