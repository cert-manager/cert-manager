...
import (
	...
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/plugin"
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/webhook/admission"
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/webhook/admission/initializer"
	...
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/webhook/server"
	"github.com/cert-manager/cert-manager/webhook-binary/pkg/webhook/server/tls"
)
