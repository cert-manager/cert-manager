...
import (
	...
	"github.com/jetstack/cert-manager/cmd/kubectl-cert_manager/pkg/convert"
	"github.com/jetstack/cert-manager/cmd/kubectl-cert_manager/pkg/create"
	"github.com/jetstack/cert-manager/cmd/kubectl-cert_manager/pkg/inspect"
	"github.com/jetstack/cert-manager/cmd/kubectl-cert_manager/pkg/renew"
	"github.com/jetstack/cert-manager/cmd/kubectl-cert_manager/pkg/status"
	"github.com/jetstack/cert-manager/cmd/kubectl-cert_manager/pkg/version"
)
