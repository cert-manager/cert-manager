...
func (in *CertificateRequestSpec) DeepCopyInto(out *CertificateRequestSpec) {
	*out = *in
	...
	if in.Extensions != nil {
		...
		*out = make(map[ExtensionOID]ExtensionValue, len(*in))
		for key, val := range *in {
			...
			if val == nil {
				...
				in, out := &val, &outVal
				*out = make(ExtensionValue, len(*in))
				copy(*out, *in)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ExtensionValue) DeepCopyInto(out *ExtensionValue) {
	{
		in := &in
		*out = make(ExtensionValue, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionValue.
func (in ExtensionValue) DeepCopy() ExtensionValue {
	if in == nil {
		return nil
	}
	out := new(ExtensionValue)
	in.DeepCopyInto(out)
	return *out
}
