...
type VenafiIssuer struct {
	// Zone is the CyberArk Certificate Manager Policy Zone to use for this issuer.
	// All requests made to the CyberArk Certificate Manager platform will be restricted by the named
	// zone policy.
