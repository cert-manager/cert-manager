...
// token. By default two audiences are included, the first being the address of
// the Vault server, and a second being taking the form of `vault://namespace-name/issuer-name`
...
type ServiceAccountRef struct {
	...
	// The default tokens are always included.
	// +optional
	// +listType=atomic
