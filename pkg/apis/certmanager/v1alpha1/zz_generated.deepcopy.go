...
func (in *ACMEIssuerDNS01Provider) DeepCopyInto(out *ACMEIssuerDNS01Provider) {
	*out = *in
	...
	if in.DNSMadeEasy != nil {
		in, out := &in.DNSMadeEasy, &out.DNSMadeEasy
		if *in == nil {
			*out = nil
		} else {
			*out = new(ACMEIssuerDNS01ProviderDNSMadeEasy)
			**out = **in
		}
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACMEIssuerDNS01ProviderDNSMadeEasy) DeepCopyInto(out *ACMEIssuerDNS01ProviderDNSMadeEasy) {
	*out = *in
	out.SecretKey = in.SecretKey
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEIssuerDNS01ProviderDNSMadeEasy.
func (in *ACMEIssuerDNS01ProviderDNSMadeEasy) DeepCopy() *ACMEIssuerDNS01ProviderDNSMadeEasy {
	if in == nil {
		return nil
	}
	out := new(ACMEIssuerDNS01ProviderDNSMadeEasy)
