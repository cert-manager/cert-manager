...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1alpha1_ACMECertData, InType: reflect.TypeOf(&ACMECertData{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1alpha1_ACMECertDetails, InType: reflect.TypeOf(&ACMECertDetails{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1alpha1_ACMEUserData, InType: reflect.TypeOf(&ACMEUserData{})},
...
func DeepCopy_v1alpha1_ACMECertData(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ACMECertData)
...
func DeepCopy_v1alpha1_ACMECertDetails(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
func DeepCopy_v1alpha1_ACMEUserData(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ACMEUserData)
