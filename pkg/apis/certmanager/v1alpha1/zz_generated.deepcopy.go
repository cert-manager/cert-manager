...
func (in *HTTP01SolverConfig) DeepCopyInto(out *HTTP01SolverConfig) {
	*out = *in
	...
	if in.SelfCheckHostSource != nil {
		in, out := &in.SelfCheckHostSource, &out.SelfCheckHostSource
		*out = new(HTTP01SolverSelfCheckHostSource)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTP01SolverSelfCheckHostSource) DeepCopyInto(out *HTTP01SolverSelfCheckHostSource) {
	*out = *in
	if in.Ingress != nil {
		in, out := &in.Ingress, &out.Ingress
		*out = new(HTTP01SolverSelfCheckIngress)
		**out = **in
	}
	if in.Service != nil {
		in, out := &in.Service, &out.Service
		*out = new(HTTP01SolverSelfCheckService)
		**out = **in
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01SolverSelfCheckHostSource.
func (in *HTTP01SolverSelfCheckHostSource) DeepCopy() *HTTP01SolverSelfCheckHostSource {
	if in == nil {
		return nil
	}
	out := new(HTTP01SolverSelfCheckHostSource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTP01SolverSelfCheckIngress) DeepCopyInto(out *HTTP01SolverSelfCheckIngress) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01SolverSelfCheckIngress.
func (in *HTTP01SolverSelfCheckIngress) DeepCopy() *HTTP01SolverSelfCheckIngress {
	if in == nil {
		return nil
	}
	out := new(HTTP01SolverSelfCheckIngress)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTP01SolverSelfCheckService) DeepCopyInto(out *HTTP01SolverSelfCheckService) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01SolverSelfCheckService.
func (in *HTTP01SolverSelfCheckService) DeepCopy() *HTTP01SolverSelfCheckService {
	if in == nil {
		return nil
	}
	out := new(HTTP01SolverSelfCheckService)
