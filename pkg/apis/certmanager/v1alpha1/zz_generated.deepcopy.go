...
func (in *ACMEIssuerDNS01Provider) DeepCopyInto(out *ACMEIssuerDNS01Provider) {
	*out = *in
	...
	if in.LiveDNS != nil {
		in, out := &in.LiveDNS, &out.LiveDNS
		if *in == nil {
			*out = nil
		} else {
			*out = new(ACMEIssuerDNS01ProviderLiveDNS)
			**out = **in
		}
	}
	if in.AcmeDNS != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACMEIssuerDNS01ProviderLiveDNS) DeepCopyInto(out *ACMEIssuerDNS01ProviderLiveDNS) {
	*out = *in
	out.APIKey = in.APIKey
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEIssuerDNS01ProviderLiveDNS.
func (in *ACMEIssuerDNS01ProviderLiveDNS) DeepCopy() *ACMEIssuerDNS01ProviderLiveDNS {
	if in == nil {
		return nil
	}
	out := new(ACMEIssuerDNS01ProviderLiveDNS)
