...
func DeepCopy_v1alpha1_ACMEDNSConfig(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ACMEDNSConfig)
...
func DeepCopy_v1alpha1_ACMEDNSConfigCloudDNS(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
