...
func (in *ACMEChallengeSolverHTTP01) DeepCopyInto(out *ACMEChallengeSolverHTTP01) {
	*out = *in
	...
	if in.Gateway != nil {
		...
		*out = new(ACMEChallengeSolverHTTP01Gateway)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEChallengeSolverHTTP01Gateway.
func (in *ACMEChallengeSolverHTTP01Gateway) DeepCopy() *ACMEChallengeSolverHTTP01Gateway {
	if in == nil {
		return nil
	}
	out := new(ACMEChallengeSolverHTTP01Gateway)
