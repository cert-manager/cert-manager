...
type ACMEChallengeSolver struct {
	...
	// +optional
	ReadinessStrategy *ChallengeReadinessStrategy `json:"readinessStrategy,omitempty"`
	...
	// +optional
	ReadinessGates []ChallengeReadinessGate `json:"readinessGates,omitempty"`
}
...
type ChallengeReadinessStrategy struct {
	...
	// Challenge has been "presented" to allow time for the resources to be
	// deployed and for them to become ready.
