...
func (r *Reporter) Failed(err error, reason, message string) {
	...
	r.Status(err, message, v1alpha1.ConditionFalse, v1alpha1.CertificateRequestReasonFailed)
}
...
func (r *Reporter) Pending(err error, reason, message string) {
	...
	r.Status(err, message, v1alpha1.ConditionFalse, v1alpha1.CertificateRequestReasonPending)
}

func (r *Reporter) Status(err error, message string, condtion v1alpha1.ConditionStatus, reasonMessage v1alpha1.CertificateConditionType) {
