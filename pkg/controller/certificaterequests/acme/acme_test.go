	...
	tests := map[string]testT{
		...
		"pass if the CN is set in the IPs": {
			...
			builder: &testpkg.Builder{
				...
				ExpectedEvents: []string{
					"Normal OrderCreated Created Order resource default-unit-test-ns/test-cr-5a334b43",
				},
				ExpectedActions: []testpkg.Action{
					...
					testpkg.NewAction(coretesting.NewUpdateSubresourceAction(
						...
						gen.CertificateRequestFrom(ipBaseCR,
							...
							gen.SetCertificateRequestStatusCondition(cmapi.CertificateRequestCondition{
								...
								Message:            "Created Order resource default-unit-test-ns/test-cr-5a334b43",
								LastTransitionTime: &metaFixedClockStart,
							}),
						),
					)),
		...
		"if order doesn't exist then attempt to create one": {
			...
			builder: &testpkg.Builder{
				CertManagerObjects: []runtime.Object{baseCR.DeepCopy(), baseIssuer.DeepCopy()},
				ExpectedEvents: []string{
					"Normal OrderCreated Created Order resource default-unit-test-ns/test-cr-9f630208",
				},
				ExpectedActions: []testpkg.Action{
					testpkg.NewAction(coretesting.NewCreateAction(
						cmacme.SchemeGroupVersion.WithResource("orders"),
					...
					testpkg.NewAction(coretesting.NewUpdateSubresourceAction(
						...
						gen.CertificateRequestFrom(baseCR,
							gen.SetCertificateRequestStatusCondition(cmapi.CertificateRequestCondition{
								...
								Status:             cmmeta.ConditionFalse,
								Reason:             cmapi.CertificateRequestReasonPending,
								Message:            "Created Order resource default-unit-test-ns/test-cr-9f630208",
								LastTransitionTime: &metaFixedClockStart,
							}),
						),
					)),
		...
		"if we fail to get the order resource due to a transient error then we should report pending and return error to re-sync": {
			...
			builder: &testpkg.Builder{
				ExpectedEvents: []string{
					"Normal OrderGetError Failed to get order resource default-unit-test-ns/test-cr-9f630208: this is a network error",
				},
				CertManagerObjects: []runtime.Object{baseCR.DeepCopy(), baseIssuer.DeepCopy()},
				ExpectedActions: []testpkg.Action{
					testpkg.NewAction(coretesting.NewUpdateSubresourceAction(
						...
						gen.CertificateRequestFrom(baseCR,
							gen.SetCertificateRequestStatusCondition(cmapi.CertificateRequestCondition{
								...
								Status:             cmmeta.ConditionFalse,
								Reason:             cmapi.CertificateRequestReasonPending,
								Message:            "Failed to get order resource default-unit-test-ns/test-cr-9f630208: this is a network error",
								LastTransitionTime: &metaFixedClockStart,
							}),
						),
					)),
		...
		"if the order resource is in a failed state then we should report failure": {
			...
			builder: &testpkg.Builder{
				ExpectedEvents: []string{
					`Warning OrderFailed Failed to wait for order resource "test-cr-9f630208" to become ready: order is in "invalid" state: simulated failure`,
				},
				CertManagerObjects: []runtime.Object{baseCR.DeepCopy(), baseIssuer.DeepCopy(),
					...
					testpkg.NewAction(coretesting.NewUpdateSubresourceAction(
						...
						gen.CertificateRequestFrom(baseCR,
							gen.SetCertificateRequestStatusCondition(cmapi.CertificateRequestCondition{
								...
								Status:             cmmeta.ConditionFalse,
								Reason:             cmapi.CertificateRequestReasonFailed,
								Message:            `Failed to wait for order resource "test-cr-9f630208" to become ready: order is in "invalid" state: simulated failure`,
								LastTransitionTime: &metaFixedClockStart,
							}),
							gen.SetCertificateRequestFailureTime(metaFixedClockStart),
						),
		...
		"if the order is in an unknown state, then report pending": {
			...
			builder: &testpkg.Builder{
				ExpectedEvents: []string{
					`Normal OrderPending Waiting on certificate issuance from order default-unit-test-ns/test-cr-9f630208: "pending"`,
				},
				CertManagerObjects: []runtime.Object{baseCR.DeepCopy(), baseIssuer.DeepCopy(),
					gen.OrderFrom(baseOrder,
					...
					testpkg.NewAction(coretesting.NewUpdateSubresourceAction(
						...
						gen.CertificateRequestFrom(baseCR,
							gen.SetCertificateRequestStatusCondition(cmapi.CertificateRequestCondition{
								...
								Status:             cmmeta.ConditionFalse,
								Reason:             cmapi.CertificateRequestReasonPending,
								Message:            `Waiting on certificate issuance from order default-unit-test-ns/test-cr-9f630208: "pending"`,
								LastTransitionTime: &metaFixedClockStart,
							}),
						),
					)),
		...
		"if the order is in Valid state but Certificate has not yet been populated": {
			...
			builder: &testpkg.Builder{
				ExpectedEvents: []string{
					"Normal OrderPending Waiting for order-controller to add certificate data to Order default-unit-test-ns/test-cr-9f630208",
				},
					...
					testpkg.NewAction(coretesting.NewUpdateSubresourceAction(
						...
						gen.CertificateRequestFrom(baseCR,
							gen.SetCertificateRequestStatusCondition(cmapi.CertificateRequestCondition{
								...
								Status:             cmmeta.ConditionFalse,
								Reason:             cmapi.CertificateRequestReasonPending,
								Message:            "Waiting for order-controller to add certificate data to Order default-unit-test-ns/test-cr-9f630208",
								LastTransitionTime: &metaFixedClockStart,
							}),
						),
					)),
