...
const (
	CRControllerName = "certificaterequests-issuer-step"
)

func init() {
	// create certificate request controller for step issuer
	controllerpkg.Register(CRControllerName, func(ctx *controllerpkg.Context) (controllerpkg.Interface, error) {
		controller := certificaterequests.New(apiutil.IssuerStep)
