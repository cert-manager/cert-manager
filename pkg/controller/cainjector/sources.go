...
// instantiation if it has the 'injector.cert-manager.io/inject-apiserver-ca'
// annotation.
...
// the 'injector.cert-manager.io/inject-ca-from' annotation in the form
// 'namespace/name'.
...
// 'injector.cert-manager.io/inject-ca-from-secret' annotation in the form
// 'namespace/name'.
