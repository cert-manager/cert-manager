...
func (q *QueuingEventHandler) OnAdd(obj interface{}, isInInitialList bool) {
	log := logf.Log.WithName("QueuingEventHandler").WithValues("event", "OnAdd")
...
func (q *QueuingEventHandler) OnUpdate(oldObj, newObj interface{}) {
	log := logf.Log.WithName("QueuingEventHandler").WithValues("event", "OnUpdate")

	u := event.TypedUpdateEvent[client.Object]{}
...
func (q *QueuingEventHandler) OnDelete(obj interface{}) {
	log := logf.Log.WithName("QueuingEventHandler").WithValues("event", "OnDelete")

	d := event.TypedDeleteEvent[client.Object]{}
