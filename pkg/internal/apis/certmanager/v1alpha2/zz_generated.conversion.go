...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha2.IssuerResponse)(nil), (*certmanager.IssuerResponse)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_IssuerResponse_To_certmanager_IssuerResponse(a.(*v1alpha2.IssuerResponse), b.(*certmanager.IssuerResponse), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.IssuerResponse)(nil), (*v1alpha2.IssuerResponse)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_IssuerResponse_To_v1alpha2_IssuerResponse(a.(*certmanager.IssuerResponse), b.(*v1alpha2.IssuerResponse), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_IssuerResponse_To_certmanager_IssuerResponse(in *v1alpha2.IssuerResponse, out *certmanager.IssuerResponse, s conversion.Scope) error {
	out.Certificate = *(*[]byte)(unsafe.Pointer(&in.Certificate))
...
// Convert_v1alpha2_IssuerResponse_To_certmanager_IssuerResponse is an autogenerated conversion function.
func Convert_v1alpha2_IssuerResponse_To_certmanager_IssuerResponse(in *v1alpha2.IssuerResponse, out *certmanager.IssuerResponse, s conversion.Scope) error {
	return autoConvert_v1alpha2_IssuerResponse_To_certmanager_IssuerResponse(in, out, s)
}

func autoConvert_certmanager_IssuerResponse_To_v1alpha2_IssuerResponse(in *certmanager.IssuerResponse, out *v1alpha2.IssuerResponse, s conversion.Scope) error {
	out.Certificate = *(*[]byte)(unsafe.Pointer(&in.Certificate))
	out.PrivateKey = *(*[]byte)(unsafe.Pointer(&in.PrivateKey))
	out.CA = *(*[]byte)(unsafe.Pointer(&in.CA))
	return nil
...
// Convert_certmanager_IssuerResponse_To_v1alpha2_IssuerResponse is an autogenerated conversion function.
func Convert_certmanager_IssuerResponse_To_v1alpha2_IssuerResponse(in *certmanager.IssuerResponse, out *v1alpha2.IssuerResponse, s conversion.Scope) error {
	return autoConvert_certmanager_IssuerResponse_To_v1alpha2_IssuerResponse(in, out, s)
}
