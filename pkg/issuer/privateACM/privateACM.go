...
func NewPrivateACM(ctx *controller.Context, issuer v1alpha1.GenericIssuer) (issuer.Interface, error) {
...
func init() {
	issuer.RegisterIssuer(apiutil.IssuerPrivateACM, NewPrivateACM)
}
