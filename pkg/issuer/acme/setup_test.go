	...
	tests := map[string]struct {
		...
		"ACME Issuer is ready, URL and email are matching": {
			issuer: gen.IssuerFrom(baseIssuer,
				...
				gen.SetIssuerACMELastRegisteredServer(acmev2Prod),
		...
		"ACME Issuer is ready, same host but different server URL path triggers re-registration": {
			issuer: gen.IssuerFrom(baseIssuer,
				gen.SetIssuerACMEURL("https://acme.example.com/v1/pma-new-policy/directory"),
				gen.SetIssuerACMEAccountURL("https://acme.example.com/acme/acct/123"),
				gen.SetIssuerACMEEmail(someEmail),
				gen.SetIssuerACMELastRegisteredEmail(someEmail),
				gen.SetIssuerACMELastPrivateKeyHash(someString),
				gen.SetIssuerACMELastRegisteredServer("https://acme.example.com/v1/pma-old-policy/directory"),
				gen.AddIssuerCondition(
					*gen.IssuerConditionFrom(readyTrueCondition,
						gen.SetIssuerConditionStatus(cmmeta.ConditionTrue)))),
			expectedConditions: []cmapi.IssuerCondition{
		...
		"ACME Issuer is ready, same host and same server URL path does not trigger re-registration": {
			issuer: gen.IssuerFrom(baseIssuer,
				gen.SetIssuerACMEURL("https://acme.example.com/v1/pma-policy/directory"),
				gen.SetIssuerACMEAccountURL("https://acme.example.com/acme/acct/123"),
				gen.SetIssuerACMEEmail(someEmail),
				gen.SetIssuerACMELastRegisteredEmail(someEmail),
				gen.SetIssuerACMELastPrivateKeyHash(someString),
				gen.SetIssuerACMELastRegisteredServer("https://acme.example.com/v1/pma-policy/directory"),
				gen.AddIssuerCondition(
					*gen.IssuerConditionFrom(readyTrueCondition,
						gen.SetIssuerConditionStatus(cmmeta.ConditionTrue)))),
			expectedConditions: []cmapi.IssuerCondition{
		...
		"ACME Issuer is ready, completely different server URL triggers re-registration": {
			issuer: gen.IssuerFrom(baseIssuer,
				gen.SetIssuerACMEURL("https://different-acme.example.com/directory"),
				gen.SetIssuerACMEAccountURL("https://acme.example.com/acme/acct/123"),
				gen.SetIssuerACMEEmail(someEmail),
				gen.SetIssuerACMELastRegisteredEmail(someEmail),
				gen.SetIssuerACMELastPrivateKeyHash(someString),
				gen.SetIssuerACMELastRegisteredServer("https://acme.example.com/directory"),
				gen.AddIssuerCondition(
					*gen.IssuerConditionFrom(readyTrueCondition,
						gen.SetIssuerConditionStatus(cmmeta.ConditionTrue)))),
			expectedConditions: []cmapi.IssuerCondition{
