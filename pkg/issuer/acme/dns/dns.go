...
type dnsProviderConstructors struct {
	...
	azureDNS     func(environment, clientID, clientSecret, subscriptionID, tenantID, resourceGroupName, hostedZoneName string, dns01Nameservers []string, ambient bool, managedIdentity *cmacme.AzureManagedIdentity, opts ...azuredns.ProviderOption[T azuredns.RecordSetTypes]) (*azuredns.DNSProvider, error)
