...
func newFakeDNSProviders() *fakeDNSProviders {
	...
	f.constructors = dnsProviderConstructors{
		...
		route53: func(ctx context.Context, accessKey, secretKey, hostedZoneID, region, role, chainRole, webIdentityToken string, ambient bool, dns01Nameservers []string, userAgent string) (*route53.DNSProvider, error) {
			f.call("route53", accessKey, secretKey, hostedZoneID, region, role, chainRole, webIdentityToken, ambient, util.RecursiveNameservers)
			return nil, nil
		},
