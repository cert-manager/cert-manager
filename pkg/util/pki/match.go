...
// supported.
// The function returns an error if the CertificateSpec is invalid (contains
// an unknown key algorithm).
...
func FuzzyX509AltNamesMatchSpec(x509cert *x509.Certificate, spec cmapi.CertificateSpec) ([]string, error) {
	var violations []string
