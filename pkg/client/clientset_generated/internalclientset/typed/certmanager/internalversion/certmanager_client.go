...
import (
	"github.com/munnerz/cert-manager/pkg/client/clientset_generated/internalclientset/scheme"
...
// CertmanagerClient is used to interact with features provided by the certmanager.k8s.io group.
...
func setConfigDefaults(config *rest.Config) error {
	g, err := scheme.Registry.Group("certmanager.k8s.io")
	if err != nil {
		return err
	}
