...
type Interface interface {
	// ACMEValidations returns a ACMEValidationInformer.
	ACMEValidations() ACMEValidationInformer
...
// ACMEValidations returns a ACMEValidationInformer.
func (v *version) ACMEValidations() ACMEValidationInformer {
	return &aCMEValidationInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
