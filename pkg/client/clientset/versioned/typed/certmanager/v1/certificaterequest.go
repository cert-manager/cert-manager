...
type CertificateRequestInterface interface {
	...
	Apply(ctx context.Context, certificateRequest *applyconfigurationcertmanagerv1.CertificateRequestApplyConfiguration, opts metav1.ApplyOptions) (result *certmanagerv1.CertificateRequest, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, certificateRequest *applyconfigurationcertmanagerv1.CertificateRequestApplyConfiguration, opts metav1.ApplyOptions) (result *certmanagerv1.CertificateRequest, err error)
	CertificateRequestExpansion
}

// certificateRequests implements CertificateRequestInterface
type certificateRequests struct {
	*gentype.ClientWithListAndApply[*certmanagerv1.CertificateRequest, *certmanagerv1.CertificateRequestList, *applyconfigurationcertmanagerv1.CertificateRequestApplyConfiguration]
}
...
func newCertificateRequests(c *CertmanagerV1Client, namespace string) *certificateRequests {
	return &certificateRequests{
		gentype.NewClientWithListAndApply[*certmanagerv1.CertificateRequest, *certmanagerv1.CertificateRequestList, *applyconfigurationcertmanagerv1.CertificateRequestApplyConfiguration](
			"certificaterequests",
			c.RESTClient(),
