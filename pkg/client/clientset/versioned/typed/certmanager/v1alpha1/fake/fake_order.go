...
var ordersResource = schema.GroupVersionResource{Group: "cert-manager.io", Version: "v1alpha1", Resource: "orders"}

var ordersKind = schema.GroupVersionKind{Group: "cert-manager.io", Version: "v1alpha1", Kind: "Order"}
