...
var issuersResource = schema.GroupVersionResource{Group: "cert-manager.io", Version: "v1alpha1", Resource: "issuers"}

var issuersKind = schema.GroupVersionKind{Group: "cert-manager.io", Version: "v1alpha1", Kind: "Issuer"}
