...
type OrderInterface interface {
	...
	Apply(ctx context.Context, order *applyconfigurationacmev1.OrderApplyConfiguration, opts metav1.ApplyOptions) (result *acmev1.Order, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, order *applyconfigurationacmev1.OrderApplyConfiguration, opts metav1.ApplyOptions) (result *acmev1.Order, err error)
	OrderExpansion
}

// orders implements OrderInterface
type orders struct {
	*gentype.ClientWithListAndApply[*acmev1.Order, *acmev1.OrderList, *applyconfigurationacmev1.OrderApplyConfiguration]
}

// newOrders returns a Orders
func newOrders(c *AcmeV1Client, namespace string) *orders {
	return &orders{
		gentype.NewClientWithListAndApply[*acmev1.Order, *acmev1.OrderList, *applyconfigurationacmev1.OrderApplyConfiguration](
			"orders",
			c.RESTClient(),
