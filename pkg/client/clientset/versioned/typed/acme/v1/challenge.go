...
import (
	...
	applyconfigurationacmev1 "github.com/cert-manager/cert-manager/pkg/client/applyconfiguration/acme/v1"
...
type ChallengeInterface interface {
	...
	Apply(ctx context.Context, challenge *applyconfigurationacmev1.ChallengeApplyConfiguration, opts metav1.ApplyOptions) (result *acmev1.Challenge, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, challenge *applyconfigurationacmev1.ChallengeApplyConfiguration, opts metav1.ApplyOptions) (result *acmev1.Challenge, err error)
	ChallengeExpansion
}

// challenges implements ChallengeInterface
type challenges struct {
	*gentype.ClientWithListAndApply[*acmev1.Challenge, *acmev1.ChallengeList, *applyconfigurationacmev1.ChallengeApplyConfiguration]
}

// newChallenges returns a Challenges
func newChallenges(c *AcmeV1Client, namespace string) *challenges {
	return &challenges{
		gentype.NewClientWithListAndApply[*acmev1.Challenge, *acmev1.ChallengeList, *applyconfigurationacmev1.ChallengeApplyConfiguration](
			"challenges",
			c.RESTClient(),
