...
type ChallengeSpecApplyConfiguration struct {
	...
	IssuerRef        *metav1.IssuerReference                `json:"issuerRef,omitempty"`
}
...
func (b *ChallengeSpecApplyConfiguration) WithIssuerRef(value metav1.IssuerReference) *ChallengeSpecApplyConfiguration {
	b.IssuerRef = &value
	return b
}
