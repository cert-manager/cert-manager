...
type ACMEIssuerDNS01ProviderRoute53ApplyConfiguration struct {
	...
	SecretAccessKeyID *v1.SecretKeySelector `json:"accessKeyIDSecretRef,omitempty"`
...
func (b *ACMEIssuerDNS01ProviderRoute53ApplyConfiguration) WithSecretAccessKeyID(value v1.SecretKeySelector) *ACMEIssuerDNS01ProviderRoute53ApplyConfiguration {
