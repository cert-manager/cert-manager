...
func (b *ACMEChallengeSolverHTTP01IngressPodSpecApplyConfiguration) WithResources(value corev1.ResourceRequirements) *ACMEChallengeSolverHTTP01IngressPodSpecApplyConfiguration {
	b.Resources = &value
	return b
}
