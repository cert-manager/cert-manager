...
type ACMEChallengeSolverHTTP01GatewayHTTPRouteApplyConfiguration struct {
	...
	ParentRefs  []v1beta1.ParentReference `json:"parentRefs,omitempty"`
}
...
func (b *ACMEChallengeSolverHTTP01GatewayHTTPRouteApplyConfiguration) WithParentRefs(values ...v1beta1.ParentReference) *ACMEChallengeSolverHTTP01GatewayHTTPRouteApplyConfiguration {
	for i := range values {
