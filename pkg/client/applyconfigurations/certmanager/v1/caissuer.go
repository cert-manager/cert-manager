...
// CAIssuerApplyConfiguration represents an declarative configuration of the CAIssuer type for use
// with apply.
...
// CAIssuerApplyConfiguration constructs an declarative configuration of the CAIssuer type for use with
// apply.
