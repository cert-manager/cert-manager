...
type CertificateRequestSpecApplyConfiguration struct {
	...
	IssuerRef *apismetav1.IssuerReference `json:"issuerRef,omitempty"`
...
func (b *CertificateRequestSpecApplyConfiguration) WithIssuerRef(value apismetav1.IssuerReference) *CertificateRequestSpecApplyConfiguration {
	b.IssuerRef = &value
	return b
}
