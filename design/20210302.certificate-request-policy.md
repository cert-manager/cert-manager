...
type CertificateRequestPolicy struct {
    ...
    Spec CertificatePolicySpec `json:"spec"`
	  ...
	  // +optional
    Status CertificatePolicyStatus `json:"status"`
}
...
type CertificateRequestPolicySpec struct {
    ...
    AllowedEmailAddresses *[]string `json:"allowedEmailAddresses,omitempty"`
	  ...
	  // +optional
    AllowedIssuer *cmmeta.ObjectReference `json:"allowedIssuer,omitempty"`
...
type CertificateRequestPolicyPrivateKey struct {
	  // +optional
    AllowedRotationPolicy *cmapi.PrivateKeyRotationPolicy `json:"allowedRotationPolicy,omitempty"`
	  // +optional
    AllowedEncoding *cmapi.PrivateKeyEncoding `json:"allowedEncoding,omitempty"`
	  // +optional
