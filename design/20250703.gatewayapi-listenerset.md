...
![Thanks to the new ListenerSet resource, migrating from Ingress to Gateway and HTTPRoute no longer means loss of self-service for application developers](./images/20250703.gatewayapi-listenerset/migrating-with-listenerset.svg)
