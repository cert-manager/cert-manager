...
###### Resource Names
The resource name is made up of 3 parts: the signer resource name, signer group, and the
signer name.

The signer resource name should be the same string of the resource name of the
signer.
