...
IMAGE_kgateway_amd64 := ghcr.io/kgateway-dev/kgateway:v2.4.5@sha256:578fc597afd631e78c4ca22849b18820d6461a6c0a3812680726cfdfd46a14a1
...
# IMAGE_kgateway_* are generated by hack/latest-kgateway-images.sh; do not edit by hand.
IMAGE_kgateway_arm64 := ghcr.io/kgateway-dev/kgateway:v2.4.5@sha256:7d1c320a7fbdbb26fa68409d397be776be4b84d7873dc985ba28bb339c3363f6
...
e2e-setup-gwapi-provider: $(call image-tar,kgateway) load-$(call image-tar,kgateway) make/config/kgateway/gateway.yaml make/config/kgateway/gwconfig.yaml $(bin_dir)/scratch/kind-exists | $(NEEDS_HELM) $(NEEDS_KUBECTL)
	...
	@$(eval KGATEWAY_HELM_VERSION=v2.4.5)
